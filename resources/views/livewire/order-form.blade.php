<div>
    ...
    <form wire:submit.prevent="submit" action="customer-data.html" class="flex flex-col gap-5">
        <div class="flex flex-col rounded-[20px] p-4 mx-4 pb-5 gap-5 bg-white">
            <div id="info" class="flex items-center justify-between">
                <div class="flex flex-col">
                    ...
                    <p class="font-semibold text-lg leading-[27px]">Rp {{ number_format($product->price, 0, ',', '.') }} . {{ $orderData['product_size'] }}</p>
                </div>
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="relative flex items-center gap-[30px]">
                    ...
                    <input type="number" wire:model.debounce.500ms="quantity" name="quantity" id="quantity" value="1" class="sr-only -z-10">
